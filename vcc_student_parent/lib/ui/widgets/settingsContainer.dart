...
import 'package:vcc_student_parent/cubits/changePasswordCubit.dart';
import 'package:vcc_student_parent/data/repositories/authRepository.dart';
import 'package:vcc_student_parent/ui/widgets/changeLanguageBottomsheetContainer.dart';
import 'package:vcc_student_parent/ui/widgets/changePasswordBottomsheet.dart';
import 'package:vcc_student_parent/ui/widgets/customBackButton.dart';
import 'package:vcc_student_parent/ui/widgets/logoutButton.dart';
    ...
    return Column(
      children: [
        ...
        GestureDetector(
          ...
          child: _buildSettingDetailsTile(
            icon: Icons.share,
